...
cell10.update(south: cell15, east: cell11)
cell11.update(west: cell0, east: cell12, south: cell16)
cell12.update(west: cell11, east: cell13, south: cell17)
cell13.update(west: cell12, east: cell14, south: cell18)
cell14.update(west: cell13, south: cell19)

cell15.update(south: cell20, east: cell16)
cell16.update(west: cell15, east: cell17, south: cell21)
cell17.update(west: cell16, east: cell18, south: cell22)
cell18.update(west: cell17, east: cell19, south: cell23)
cell19.update(west: cell18, south: cell24)

cell20.update(north: cell15, east: cell21)
